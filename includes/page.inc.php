	  ...
	  */	   
      ...
      function get_next_page_nav($user_link="",$link_para="")
      {
        ...
        if(!$this->is_last_page()&& $this->show_prev_next)
            echo ' <a href="'.$this->page_name.'?page='.($this->page+1).$this->qry_str.'" '.$link_para.' class="blueLink">'.$user_link.'</a> ';
        elseif($this->show_prev_next && $this->show_disabled_links)
            echo "<span class='blue_text'>".$user_link."</span>";
      }
      ...
      function get_number_page_nav($link_para="")
      {
        ...
        {
         if($i==$this->page)
            echo ' <span class="blue_text">'.($i+1).'</span> ';
         else
            echo ' <a href="'.$this->page_name.'?page='.$i.$this->qry_str.'" '.$link_para.' class="blueLink">'.($i+1).'</a> ';
        }
      }
