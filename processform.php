...
if( $_POST['reserv'] == "Reserve" or $_POST['checkin']=="Check-In" or $_POST['block']=="Block") {
...
if($_POST['reserv'] == "Reserve"){  $status = "reserved";}
if($_POST['checkin'] == "Check-In"){  $status = "check-in";}
if($_POST['block'] == "Block"){  $status = "block";}
