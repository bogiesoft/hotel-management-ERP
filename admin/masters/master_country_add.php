...
if( $_REQUEST['task'] == "active" && preg_match("/^([0-9]+)$/", $_REQUEST['id'], $reg) ) {
	$qry = " update ".COUNTRY." set is_active='1' where id=".$_REQUEST['id'];
	$db->query( $qry );
...
if( $_REQUEST['task'] == "deactive" && preg_match("/^([0-9]+)$/", $_REQUEST['id'], $reg) ) {
	$qry = " update ".COUNTRY." set is_active='0' where id=".$_REQUEST['id'];
	$db->query( $qry );
...
if( $_REQUEST['task'] == "delete_single" && preg_match("/^([0-9]+)$/", $_REQUEST['id'], $reg) ) {
    $qry = " delete from ".COUNTRY." where id=".$_REQUEST['id'];
	$db->query( $qry );
...
$insertArr = array(
	        ...
	        $last_insert_id = insertData($insertArr, COUNTRY);
...
<tr bgcolor="#FFFFFF" >
<td height="25" valign="middle" align="left" class="blue12">&nbsp;&nbsp;&nbsp;Add New Country </td>
</tr>
<tr><td>
<?php echo $eerorMsg; ?>	
...
<td>
		  ...
		  <tr>
		  <td  align="left" class="td_row_padding" >&nbsp;Country Name&nbsp;<font color="#FF0000">*</font></td>
 		  <td  align="left" class="td_row" colspan="2">&nbsp;<input type="text" name="countryname" value="" class="text" required="required"> </td>
		  </tr>

		  <tr>
		  <td  align="left" class="td_row_padding">&nbsp;Country Short Name&nbsp;<font color="#FF0000">*</font></td>
 		  <td  align="left" class="td_row" colspan="2">&nbsp;<input type="text" name="countryshort" value="" class="text" required="required"></td>
		  </tr>
...
<td bgcolor="#10147E">
    ...
    <table width="100%"  cellpadding="1" cellspacing="1"  border="0">
		  <tr>
		  <td width="5%"  align="center" class="td_heading"><input type="checkbox" name="chkAll" onclick="checkAll(document.frmMember, this.checked);"></td>
		  <td width="27%"  align="left" class="td_heading">&nbsp;Country Name </td>
		  <td width="53%"  align="left" class="td_heading">&nbsp;Country Short Name </td>
		  <td width="15%"  align="center" class="td_heading">&nbsp;Action </td>
		  </tr>
		  <?php
		   //$qry .= " order by dob"; 
		   $db->query( $qry );
		  ...
		  <td  align="left" class="td_row">&nbsp;<?php echo $data['name'];?></td>
		  <td  align="left" class="td_row">&nbsp;<?php echo $data['sh_name'];?></td>
