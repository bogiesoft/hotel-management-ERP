...
if( $_POST['submit'] == "Submit" ) {
	 ...
	 updateData($updateArr, ROOMTYPE,  $whereClause );
	redirect("membership.php?module=master_room_type");
}
//print_r($insertArr);	 
	 ######## DISPLAY RECORD #############
$qry = " select * from ".ROOMTYPE." where id='".$_GET['id']."'";
$db->query( $qry );
if( $db->numRows() > 0 ) {
	$data = $db->fetchArray();
}
...
<tr bgcolor="#FFFFFF" >
<td height="25" valign="middle" align="left" class="blue12">&nbsp;&nbsp;&nbsp;Edit New Room Type </td>
</tr>
<tr><td>
...
<td>
		  ...
		  <tr>
		    ...
		    <td  align="left" class="td_row" colspan="2">&nbsp;<input type="text" name="room_type" value="<?php echo $data['room_type'] ?>" class="text" required> </td>
		    </tr>
