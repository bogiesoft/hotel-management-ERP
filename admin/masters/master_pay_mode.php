...
$insertArr = array(
	        ...
	        $last_insert_id = insertData($insertArr, PAYMODE);
			redirect("membership.php?module=master_pay_mode&msg=1");
	 }
//print_r($insertArr);	 
	 ######## DISPLAY RECORD #############
$qry = " select * from ".PAYMODE."";
$db->query( $qry );
if( $db->numRows() > 0 ) {
	$data = $db->fetchArray();
}
...
<tr bgcolor="#FFFFFF" >
<td height="25" valign="middle" align="left" class="blue12">&nbsp;&nbsp;&nbsp;Add Payment Mode</td>
</tr>
<tr><td>
...
<td>
		  ...
		  <tr>
		    ...
		    <td  align="left" class="td_row" colspan="2">&nbsp;<input type="text" name="payment_mode" value="" class="text" required="required"> </td>
		    </tr>
...
<td bgcolor="#10147E">
    ...
    <table width="100%"  cellpadding="1" cellspacing="1"  border="0">
		  <tr>
		  <td width="4%"  align="center" class="td_heading"><input type="checkbox" name="chkAll" onclick="checkAll(document.frmMember, this.checked);"></td>
		  <td width="78%"  align="left" class="td_heading">&nbsp;Identity Name </td>
		  <td width="18%"  align="center" class="td_heading">&nbsp;Action </td>
		  </tr>
		  <?php
		   //$qry .= " order by dob"; 
		   $db->query( $qry );
		  ...
		  <td  align="left" class="td_row">&nbsp;<?php echo $data['payment_mode'];?></td>
