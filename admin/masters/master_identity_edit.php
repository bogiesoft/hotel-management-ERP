...
if( $_POST['submit'] == "Submit" ) {
	 ...
	 updateData($updateArr, IDENTITY,  $whereClause );
...
<tr bgcolor="#FFFFFF" >
<td height="25" valign="middle" align="left" class="blue12">&nbsp;&nbsp;&nbsp;Edit Identity </td>
</tr>
<tr><td>
...
<td>
		  ...
		  <tr>
		    ...
		    <td  align="left" class="td_row" colspan="2">&nbsp;<input type="text" name="idname" value="<?php echo $data['identity']?>" class="text" required="required"> </td>
		    </tr>
