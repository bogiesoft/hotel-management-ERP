...
if( $_REQUEST['task'] == "active" && preg_match("/^([0-9]+)$/", $_REQUEST['id'], $reg) ) {
	$qry = " update ".RFACILITY." set is_active='1' where id=".$_REQUEST['id'];
	$db->query( $qry );
...
if( $_REQUEST['task'] == "deactive" && preg_match("/^([0-9]+)$/", $_REQUEST['id'], $reg) ) {
	$qry = " update ".RFACILITY." set is_active='0' where id=".$_REQUEST['id'];
	$db->query( $qry );
...
if( $_REQUEST['task'] == "delete_single" && preg_match("/^([0-9]+)$/", $_REQUEST['id'], $reg) ) {
    $qry = " delete from ".RFACILITY." where id=".$_REQUEST['id'];
	$db->query( $qry );
...
$insertArr = array(
			...
			"facility"	      =>  putData( $_POST['facility'] )

			);
			
	        $last_insert_id = insertData($insertArr, RFACILITY);
			redirect("membership.php?module=master_room_facilities&msg=1");
	 }
//print_r($insertArr);	 
	 ######## DISPLAY RECORD #############
$qry = " select * from ".RFACILITY." order by id desc";
$db->query( $qry );
if( $db->numRows() > 0 ) {
	$data = $db->fetchArray();
}
...
<tr bgcolor="#FFFFFF" >
<td height="25" valign="middle" align="left" class="blue12">&nbsp;&nbsp;&nbsp;Add New Facility </td>
</tr>
<tr><td>
...
<td>
		  ...
		  <tr>
		    <td  align="center" class="td_heading" colspan="3">Facility Information</td></tr>
		  ...
		  <tr>
		    <td  align="left" class="td_row_padding" >&nbsp;Facility Name&nbsp;<font color="#FF0000">*</font></td>
		    <td  align="left" class="td_row" colspan="2">&nbsp;<input type="text" name="facility" value="" class="text" required="required"> </td>
		    </tr>
...
<td bgcolor="#10147E">
    ...
    <table width="100%"  cellpadding="1" cellspacing="1"  border="0">
		  ...
		  <td width="83%"  align="left" class="td_heading">&nbsp;Facility Name</td>
		  <td width="12%"  align="center" class="td_heading">&nbsp;Action </td>
		  </tr>
		  <?php
		   //$qry .= " order by dob"; 
		   $db->query( $qry );
		  ...
		  <td  align="left" class="td_row">&nbsp;<?php echo $data['facility'];?></td>
