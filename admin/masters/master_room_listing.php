...
if( $_REQUEST['task'] == "active" && preg_match("/^([0-9]+)$/", $_REQUEST['id'], $reg) ) {
	$qry = " update ".ROOMS." set is_active='1' where id=".$_REQUEST['id'];
	$db->query( $qry );
...
if( $_REQUEST['task'] == "deactive" && preg_match("/^([0-9]+)$/", $_REQUEST['id'], $reg) ) {
	$qry = " update ".ROOMS." set is_active='0' where id=".$_REQUEST['id'];
	$db->query( $qry );
...
if( $_REQUEST['task'] == "delete_single" && preg_match("/^([0-9]+)$/", $_REQUEST['id'], $reg) ) {
    $qry = " delete from ".ROOMS." where id=".$_REQUEST['id'];
	$db->query( $qry );
...
if( $_REQUEST['task'] == "delete" ) {
	$qry = " delete from ".ROOMS." where id in(".@implode(",", $_POST['chk']).")";
	$db->query( $qry );
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
    <td  class="blue12">Room Listing</td>
  </tr>
    <tr>
      <td>&nbsp;</td>
    </tr>
...
<td bgcolor="#10147E">
    ...
    <table width="100%"  cellpadding="1" cellspacing="1"  border="0">
		  <tr>
		  <td width="2%"  align="center" class="td_heading"><input type="checkbox" name="chkAll" onclick="checkAll(document.frmMember, this.checked);"></td>
		  <td width="9%"  align="left" class="td_heading">&nbsp;Room Number</td>
		  <td width="7%"  align="left" class="td_heading">Acronym</td>
		  <td width="9%"  align="left" class="td_heading">Room Type</td>
		  <td width="7%"  align="left" class="td_heading">Single / Double</td>
		  <td width="16%"  align="left" class="td_heading">Room Facilities</td>
		  <td width="20%"  align="left" class="td_heading">Description</td>
		  <td width="7%"  align="left" class="td_heading">Default Occupance</td>
		  <td width="6%"  align="left" class="td_heading">Max Occupance</td>
		  <td width="7%"  align="left" class="td_heading">Floor</td>
		  <td width="10%"  align="center" class="td_heading">&nbsp;Action </td>
		  </tr>
		  <?php
		   //$qry .= " order by dob"; 
		   $db->query( $qry );
		  ...
		  <td  align="left" class="td_row">&nbsp;<?php echo $data['room_no'];?></td>
		  <td  align="left" class="td_row">&nbsp;<?php echo $data['room_name'];?></td>
		  <td  align="left" class="td_row">&nbsp;<?php echo $data['room_type'];?></td>
		  <td  align="left" class="td_row">&nbsp;<?php echo $data['room_volume'];?></td>
		  <td  align="left" class="td_row">&nbsp;<?php echo $data['room_facilities'];?></td>
		  <td  align="left" class="td_row">&nbsp;<?php echo $data['description'];?></td>
		  <td  align="left" class="td_row">&nbsp;<?php echo $data['default_occupancy'];?></td>
		  <td  align="left" class="td_row">&nbsp;<?php echo $data['max_occupancy'];?></td>
		  <td  align="left" class="td_row">&nbsp;<?php echo $data['floor'];?></td>
		 ...
		 <?php } ## END OF WHILE?>	
		  ...
		  <td  class="tableborder" align="right" colspan="17"><span class="Heading">&nbsp;<?php $page->get_page_nav(); ?></span>&nbsp;</td>
		  </tr>
		  <?php } ## END OF IF STATEMENT 
			else {
		  ?>	
		 <tr bgcolor='White'><td colspan='17' class='message' align='center'>NO RECORD FOUND!!!</td></tr>
		 <?php } #### END OF ELSE  ?>
		 </table>
         </td>
  </tr>
