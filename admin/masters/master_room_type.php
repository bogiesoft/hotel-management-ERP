...
if( $_REQUEST['task'] == "active" && preg_match("/^([0-9]+)$/", $_REQUEST['id'], $reg) ) {
	$qry = " update ".ROOMTYPE." set is_active='1' where id=".$_REQUEST['id'];
	$db->query( $qry );
...
if( $_REQUEST['task'] == "deactive" && preg_match("/^([0-9]+)$/", $_REQUEST['id'], $reg) ) {
	$qry = " update ".ROOMTYPE." set is_active='0' where id=".$_REQUEST['id'];
	$db->query( $qry );
...
if( $_REQUEST['task'] == "delete_single" && preg_match("/^([0-9]+)$/", $_REQUEST['id'], $reg) ) {
    $qry = " delete from ".ROOMTYPE." where id=".$_REQUEST['id'];
	$db->query( $qry );
...
$insertArr = array(
	        ...
	        $last_insert_id = insertData($insertArr, ROOMTYPE);
			redirect("membership.php?module=master_room_type&msg=1");
	 }
//print_r($insertArr);	 
	 ######## DISPLAY RECORD #############
...
<tr bgcolor="#FFFFFF" >
<td height="25" valign="middle" align="left" class="blue12">&nbsp;&nbsp;&nbsp;Add New Room Type </td>
</tr>
<tr><td>
...
<td>
		  ...
		  <tr>
		    <td  align="center" class="td_heading" colspan="3">Room Type Information</td></tr>
		  ...
		  <tr>
		    <td  align="left" class="td_row_padding" >&nbsp;Room Type&nbsp;<font color="#FF0000">*</font></td>
		    <td  align="left" class="td_row" colspan="2">&nbsp;<input type="text" name="room_type" value="" class="text" required="required"> </td>
		    </tr>
...
<td bgcolor="#10147E">
    ...
    <table width="100%"  cellpadding="1" cellspacing="1"  border="0">
		  ...
		  <td width="78%"  align="left" class="td_heading">&nbsp;Identity Name </td>
		  <td width="17%"  align="center" class="td_heading">&nbsp;Action </td>
		  </tr>
		  <?php
		   //$qry .= " order by dob"; 
		   $db->query( $qry );
